...
public interface DatabaseHandler {
	 ...
	 */
	abstract public int addTransportAgents(List<TransportAgent> transportAgents);
	 ...
	 */
	abstract public int updateTransportAgents(List<TransportAgent> transportAgents);
	 ...
	 */
	abstract public int removeTransportAgents(List<Integer> transportAgentIDs);
	 ...
	 */
	abstract public List<TransportAgent> getTransportAgents(List<Integer> transportAgentIDs);
	 ...
	 */
	abstract public int addCells(List<Cell> cells);
	 ...
	 */
	abstract public int updateCells(List<Cell> cells);
	 ...
	 */
	abstract public int removeCells( List<Integer> cellIDs);
	 ...
	 */
	abstract public List<Cell> getCells(List<Integer> cellIDs);
	 ...
	 */
	abstract public int addRoutes(List<Route> routes);
	 ...
	 */
	abstract public int updateRoutes(List<Route> routes);
	 ...
	 */
	abstract public int removeRoutes(List<Route> routes);
	 ...
	 */
	abstract public List<Route> getRoutes(List<Integer> transportAgentIDs);
}
