...
public class JDBCDatabaseHandler implements DatabaseHandler {
	...
	public int addTransportAgents(@WebParam(name = "transportAgents") List<TransportAgent> transportAgents) {
		...
		try {
			...
			try {
				...
				logger.severe("Could not roll back changes to database: " + databaseName + " table: " + transportAgentsTable);
				logger.severe(e.getMessage());
			}
		} finally {
			if (ps != null) {
	...
	@WebMethod(operationName = "addCells")
	public int addCells(@WebParam(name = "cells") List<Cell> cells) {
		...
		try {
			...
			try {
				...
				logger.severe("Could not roll back changes to database: " + databaseName + " table: " + cellsTable);
				logger.severe(e.getMessage());
			}
		} finally {
			if (ps != null) {
	...
	@WebMethod(operationName = "removeCells")
	...
	@WebMethod(operationName = "getCells")
	...
	@WebMethod(operationName = "addRoutes")
	public int addRoutes(@WebParam(name = "routes") List<Route> routes) {
		...
		try {
			...
			try {
				...
				logger.severe("Could not roll back changes to database: " + databaseName + " table: " + routesTable);
				logger.severe(e.getMessage());
			}
		} finally {
			if (ps != null) {
	...
	@WebMethod(operationName = "updateRoutes")
	...
	@WebMethod(operationName = "removeRoutes")
